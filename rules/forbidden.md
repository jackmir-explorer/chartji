...
- **예외 — 자동 routine 산출물 (2026-04-22 확정)**: `routines/deep-extract.md` 등 **자동 routine이 생성하는 md 파일 반영**은 PR 없이 **main 직접 머지**. 미르가 쓴 💬 반응 한 문장(2026-07-16 답변 게이트) 자체가 ingest 승인 신호이므로 추가 게이트 불필요. 과거 routine 명세의 "PR 생성 후 미르 승인" 경로는 폐기. (`routines/scout.md`는 별도 규칙 유지 — Scout PR 방식은 trigger 진단 세션 2026-04-19 후 확정된 경로로 존속.)
