...
| 임상영양 | 🟡 부분 | `vitamin-d`, obesity 단백질 ABC (일반 식습관·영양제 공백) |
...
### Tier 4 — 트렌드 파악
전부 🔴 **공백** (재택의료·호스피탈리스트·의학 AI·보완적 접근)
...
1. **호흡기 전체** — 감기·천식·COPD·폐렴 등 외래 최다 CC 축
2. **소화기 전체** — GERD 본체·IBS·변비·설사·치질·지방간 등
3. **근골격·통증 전체** — 요통·경추통·관절통·통풍
4. **당뇨 본체** — 약물 side만 있고 질환 관리·합병증·HbA1c 전략 없음
5. **이상지질혈증** — statin·non-statin 선택·검사 주기 없음
6. **건강검진 상담** — 암 스크리닝 결과 해석·권고

### 🟡 준공백 (Tier 2 자주 만나는)
7. **비뇨의학** — UTI·전립선·배뇨장애
8. **노인의학** — 노쇠·낙상·다약제·인지기능
9. **정신건강** — 불안·공황·불면 (우울만 있음)
10. **피부과** — 악성 병변 감별·피부감염
11. **갱년기·월경이상** — HRT만 있고 갱년기 본체·월경장애 없음
