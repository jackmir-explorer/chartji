# 알코올사용장애 (Alcohol Use Disorder, AUD) [CLINICAL]
...
applicability: 성인 AUD 환자 (DSM-5 기준), 일차의료 외래
parents: []
relations: []

> primarySources (Tier 1):
> - McPheeters M et al. Pharmacotherapy for Alcohol Use Disorder: A Systematic Review and Meta-Analysis. JAMA 2023;330(17):1653-1665. PMID:37934220, DOI:10.1001/jama.2023.19761 (AHRQ systematic review, 118 trials N=20,976)
> - Bernstein EY et al. Outcomes After Initiation of Medications for Alcohol Use Disorder at Hospital Discharge. JAMA Netw Open 2024;7(3):e243387. PMID:38551564, DOI:10.1001/jamanetworkopen.2024.3387

---

## 정의 (definition)

알코올사용장애(AUD)는 DSM-5 기준 11개 항목 중 2개 이상을 12개월 내 충족하는 **만성 재발성 질환**. 미국 기준 성인 2,830만 명. AUD에 대한 **FDA 승인 약물(MAUD)은 효과적이나 과소처방** 상태 — 입원 환자 중 2% 미만만 처방 받음(Bernstein 2024). **일차의료에서 정신과 의뢰 전 1차 시도가 안전·효과적**이라는 근거가 확립되었다.

> 출처: McPheeters M et al. JAMA 2023 / Bernstein EY et al. JAMA Netw Open 2024
...
### Step 2 — 1st line 약물 선택
McPheeters 2023 메타분석 결과 (vs placebo):
...
> 출처: McPheeters M et al. JAMA 2023

---

## 용량 (dosing)

### 날트렉손 (Naltrexone) — 1st line
...
- "AUD는 만성질환입니다. 혈압·당뇨처럼 약과 상담으로 관리합니다. 의지 문제가 아닙니다."
...
> 출처: Bernstein EY et al. JAMA Netw Open 2024. PMID:38551564
