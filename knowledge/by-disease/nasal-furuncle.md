# 코 furuncle / 비강 절종 (Nasal Furuncle / Vestibulitis)

keywords: 코 furuncle, nasal furuncle, nasal vestibulitis, 코 뾰루지, 비전정염, 코끝 종기, suprax, 세픽심, cefixime, mupirocin, danger triangle

tags: [TIPS]

[출처: AAFP·UpToDate 표준 (researcher 검증 보류 — 강의 노트 정렬)]

---

## 정의 (definition)

비강 전정(nasal vestibule) 또는 콧방울·코끝의 화농성 모낭염/절종. 주된 원인균 **Staphylococcus aureus** (MSSA·MRSA 가능). **얼굴 danger triangle**에 위치 → 해면정맥동 혈전증 등 합병증 위험으로 보수적 관리 필수.
...
### Danger Triangle [TIPS — by 강윤진 교수님]
