...
version: (미정)
supersedes: (미정)
freshness.primarySourceYear: 2020
applicability: 외래 성인 혈뇨 1차 평가
relations: []
...
- **Gross hematuria** (육안 혈뇨)
- **Microscopic hematuria (MH)** — AUA 2020: **미세현미경에서 ≥3 RBC/HPF 1회 확인** = 진단 (이전 "2회 이상" 기준은 표준 아님)

---

## 문진

- 통증·육안혈뇨 여부, 항응고제·항생제·NSAIDs, 암환자(항암·RT 병력)
- 상황: 운동, 스트레스, 생리 중, 하부요로증상 (LUTS)
- 약물·음식·한약 (위양성 dipstick 원인) 확인

---

## 1차 평가

> 근거: AUA/SUFU 2020 Microhematuria Guideline (J Urol 2020;204:778)

### Step 1 — 진짜 혈뇨 확인
- Dipstick (+) → **미세현미경 1회 ≥3 RBC/HPF** 확인 시 MH 진단
- 단백뇨 동반 검사, dysmorphic RBC, RBC cast 확인

### Step 2 — 사구체 vs 비사구체 감별
| 패턴 | 소견 | 다음 단계 |
|---|---|---|
| **사구체혈뇨** | RBC cast(+), Dysmorphic RBC >40%, 단백뇨 동반 | **신장내과 의뢰** |
| **비사구체혈뇨** | 종양·결석·외상·염증 | 상부+하부요로 평가 |

> ⚠ Routine 혈액검사(CBC/PT/aPTT/Uric acid/Ca/P)는 AUA 가이드라인 표준 권고 아님 — 임상 의심 시만 선택적.

### Step 3 — 비사구체혈뇨 위험도 분류 (AUA 2020 risk-stratified)

| 위험군 | 평가 |
|---|---|
| **Low** | 공유의사결정으로 6개월 내 UA 재검 또는 cystoscopy + renal US |
| **Intermediate** | **cystoscopy + renal US** |
| **High** | **cystoscopy + CT urography** |

위험요인: 연령(≥60세), 성별(M), 흡연력, RBC/HPF 정도, 지속성, 과거 육안혈뇨.

> CT urography가 sono보다 상부요로 악성 검출에 우월. 2025 amendment에서 위험 기준 정교화 + 요바이오마커 도입.

---

## 의뢰 기준

- **사구체혈뇨 (RBC cast/dysmorphic/단백뇨)** → 신장내과
- **비사구체혈뇨 Intermediate~High risk** → 비뇨기과 (cystoscopy)
- 육안혈뇨 + 통증·발열 → 응급평가 (감염·결석)
