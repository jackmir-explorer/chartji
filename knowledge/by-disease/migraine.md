...
keywords: 편두통, migraine, 두통, headache, propranolol, topiramate, CGRP, 예방치료, 만성편두통, botox

version: (미정)
supersedes: (미정)
freshness.primarySourceYear: 2025
applicability: 성인 편두통 환자 (예방치료 적응증 해당자)
...
> [출처: Moreland P et al. Am Fam Physician 2025;111(5):443-450. PMID:40378325] [초록 기반 — 전문 미확인]
...
| **Topiramate** | 항경련제; 임신 금기(기형 위험), 체중 감소 부작용 |
| **Divalproex / Valproate** | 항경련제; 임신 금기, 체중 증가 부작용 |
| **CGRP 수용체 길항제** (erenumab 등) | 편두통 특이 예방약; **비용·보험 장벽** 현실적 제약 |
...
| **운동** | 지지 근거 있음 |
| 신경 자극기(Neural stimulators) | 다양한 근거 |
| Feverfew, 마그네슘, 멜라토닌 | 효과 있음; 일반적으로 내약성 양호 |

---

## 1차의료 적용 (referral) [CLINICAL]

- **일차의료에서 처방 가능**: propranolol, metoprolol, topiramate, amitriptyline
- CGRP 길항제: 비용 장벽 상담 후 처방 여부 결정
- Botox / 신경자극기: 신경과 의뢰
- 예방치료 2~3종 실패 시 신경과 의뢰 고려

---

## 관련 엔트리

- [[dizziness]] — 편두통성 어지럼증(전정 편두통) 감별
