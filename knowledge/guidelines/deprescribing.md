...
**주의:** 치매 환자 PHQ-9 정확도 낙음 (인지 저하로 과소보고); BPSD 조절 목적 SSRIs는 개별화 판단 필요 — 무조건 중단 금지
...
**임상 메시지:**
- 정신과 약물 감약이 낙상을 줄이지만 **효과는 고충실도 프로그램에서만** → "줄여보습시다" 막연한 접근 ✗
- **고충실도 = 구조화 프로토콜(STOPP/START 등) + 환자·보호자 교육 병행 + 체계적 추적**
- 근거 수준: 낙음~매우 낙음 (GRADE) — 방향성은 명확, 확증 시험 필요
