# Endocrinology 2025 Update — 한눈에 보기 [CLINICAL]
...
applicability: 가정의학과 외래 — 2025년 내분비 변화 한눈에 파악
parents: []
relations: [[glp1-selection-strategy]], [[sglt2-inhibitors]], [[MASH]], [[cardiology-2025-update]]]
...
> 본 파일은 `internal-medicine-2025-update`(Cardiology + Endocrinology 합본) entry에서 분리(2026-05-07 Auditor Tier 1 분할).
> 심장내과 영역은 [[cardiology-2025-update]] 참조.

---

## 내분비 2025 핵심 변화 (notes)

> [출처: Update in Endocrinology 2025. Ann Intern Med 2026. PMID:41974004]
