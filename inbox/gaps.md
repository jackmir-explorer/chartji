...
- [x] [진단추론] anchoring 검증 — "이 한 수치가 현재 가설로 설명되는가?" 자문 / 가설로 설명 안 되는 1개 데이터가 진짜 단서 (→ PMID 38365449, 2026-05-19)
- [x] [가래 색·acute bronchitis] 누런 가래 = 세균감염 myth — 호중구 MPO 산물, Cochrane RCT에서 ABx 효과 예측 인자 아님 / acute bronchitis 90%+ 바이러스성, 가래 색·인후통 단독 ABx trigger 금지 (→ PMID 39596717, 2026-05-19)
