<!-- 아래에 한 줄씩 추가 -->
- [x] [진단추론] lab-driven thinking 회피 — 주호소→가설→검증 순서, 검사 이상치에서 역산 금지 (→ PMID 40445787, 2026-05-20)
- [x] [진단추론] Symptom to Diagnosis (Stern) 증상→감별 사고 흐름 훈련 (→ PMID 40445787, 2026-05-20)
- [x] [진단추론] pretest probability — 경계역 lab(TSH 4.9 등) 하나로 다증상 설명 회피 (→ PMID 41490105, 2026-05-20)
- [고령 비특이증상] 65세+ "기운없음" 감별 알고리즘 — 감염·심부전·악성·우울·약물·갑상선·빈혈·전해질
- [x] [고령 입원후] post-hospitalization syndrome (Krumholz NEJM 2013) — deconditioning·식욕·인지 변화 (→ PMID 41186737, 2026-05-20)
