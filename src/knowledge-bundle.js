...
var _glp1_strategy_v2 = {
  ...
  primarySources: [
    ...
    "Hong K et al. Oral Nutritional Supplements and Body Composition Outcomes Among GLP-1 RA Users. Diabetes Metab Syndr Obes 2026;19:574765. PMID:42117035, DOI:10.2147/DMSO.S574765"
  ],
  sections: {
    comparison: {
...
var _ibd_v2 = {
  kind: "disease",
  keywords: ["ibd", "IBD", "염증성 장 질환", "크론병", "Crohn disease", "궤양성대장염", "ulcerative colitis"],
  version: null,
  supersedes: null,
  "freshness.primarySourceYear": 2025,
  applicability: "1차 의료",
  relations: [],
  primarySources: ["Narula N et al. Ultra-Processed Grains and Risk of IBD: Results From the PURE Study. Am J Gastroenterol 2025. PMID:40758217, DOI:10.14309/ajg.0000000000003700"],
  sections: {
    "classification": {
      content: "**크론병**: 소화기관 전체(입~항문) 만성 염증. 복통·설사·체중감소. 드물게 관절염·항문 주위 농양.\n\n**궤양성대장염 (UC)**: 대장 점막 한정 염증. 혈변·잦은 설사·잔변감(직장에서 시작).\n\n**한국 역학**: 2023년 92,665명 (2019 대비 30%↑, 건보심사평가원). 환자 4명 중 1명은 20-30대.",
      sources: []
    },
    "lifestyle": {
      content: "**초가공곡물 섭취 → IBD 위험 증가 (PURE Study, 관찰연구)**:\n- ≥19g/day vs <9g/day → 86%↑ (HR 1.86)\n- ≥5회/day 초가공식품 → 최대 4배↑\n- 가공 식빵 ≥30g/day (약 1장) → 2.1배↑ (HR 2.11, 95% CI 1.65–2.70)\n\n**초가공곡물 예시**: 시리얼·크래커·공장 식빵·파이·패스트리·냉동 피자. 유화제·보존제·안정제 → 장 점막 장벽 약화 + 장내 미생물 변화 기전 추정.\n\n**보호**: 갓 구운 빵·쌀밥·통밀 케이크 → IBD 위험 감소 경향.\n\n⚠ 관찰연구 (인과관계 미확정). 초가공곡물 제한 권고.",
      sources: ["[INSIGHTS — by 코메디닷컴/Narula 2025]", "Narula N et al. Am J Gastroenterol 2025. PMID:40758217"]
    },
    "referral": {
      content: "IBD 의심 증상(혈변·만성 설사·복통·체중감소) → 소화기내과 (대장내시경 + 조직검사)\n\n감별 워크업 → chronic-diarrhea-workup 참조",
      sources: []
    }
  },
  uiHooks: null
};
KNOWLEDGE_BUNDLE["ibd"] = _ibd_v2;
KNOWLEDGE_BUNDLE["IBD"] = _ibd_v2;
...
/* clinical-experience-quality — 임상 경력과 진료 질의 역관계 (Choudhry 2005 체계적 고찰). 의사 자가 점검용 topic. [CLINICAL] */
var _clinical_experience_quality_v2 = {
  kind: "topic",
  keywords: ["clinical-experience-quality","임상 경력과 진료 질","clinical experience","years in practice","physician age","지식 노후화","knowledge decay","평생교육","CME"],
  primarySources: [
    ...
    "Tsugawa Y et al. Physician age and outcomes in elderly patients in hospital in the US. BMJ 2017;357:j1797. PMID:28512089, DOI:10.1136/bmj.j1797",
    "Tsugawa Y et al. Age and sex of surgeons and mortality of older surgical patients. BMJ 2018;361:k1343. PMID:29695473, DOI:10.1136/bmj.k1343"
  ],
  sections: {
    definition: {
      content: "**\"경력이 쌓이면 진료의 질도 올라간다\"는 통념을 정면으로 반박한 체계적 고찰.**\n\n일반적 믿음은 의사가 수년간 진료하며 지식·기술을 축적하므로 더 나은 의료를 제공한다는 것이다. 그러나 실증 근거는 **졸업 후 경과 연수와 진료의 질 사이에 역(inverse)관계**를 시사한다.\n\n- 대상: 지식(knowledge) 또는 진료 질(quality-of-care) outcome에 실증 결과를 제시하면서 **졸업 후 연수 또는 의사 연령을 설명변수로 포함**한 연구\n- 검색: MEDLINE 1966 ~ 2004년 6월 영문 논문 + 검색된 논문의 참고문헌 목록\n- 분석 단위: 논문이 아니라 **evaluation(평가) 단위 62건**\n\n> ⚠ **[CLINICAL — 조건부]** — 2005년 결론은 후속 근거에서 무조건 성립하지 않는다. 진료량·영역(인지 vs 술기)·현재 지식수준에 따라 갈린다. `follow-up-evidence` 섹션을 함께 읽을 것.\n\n> 이 엔트리는 환자 진료 알고리즘이 아니라 **의사 본인의 진료 질 유지 전략** 문서다. Triage 감지(calcCategories) 대상이 아니며 Guide tab 큐레이션 전용.",
      sources: []
    },
    "evidence-distribution": {
      content: "### 62개 evaluation 결과 분포\n\n| 경력 ↔ 수행 관계 | 건수 | 비율 |\n|---|---|---|\n| **모든 outcome에서 경력↑ → 수행↓** | **32** | **52%** |\n| 일부 outcome에서 수행↓, 나머지는 무관 | 13 | 21% |\n| 무관 (no association) | 13 | 21% |\n| 오목형(concave) — 상승 후 정점, 이후 하락 | 2 | 3% |\n| 일부 outcome에서 수행↑, 나머지는 무관 | 1 | 2% |\n| 모든 outcome에서 경력↑ → 수행↑ | 1 | 2% |\n\n**핵심 판독:**\n- 경력 증가가 수행 저하와 연관된 evaluation이 **45/62 (73%)** — 전부(32) 또는 일부(13)\n- 경력이 도움된 evaluation은 **2/62 (3%)**뿐\n- **가장 객관적인 outcome measure만으로 제한해 재분석해도 결과는 실질적으로 변하지 않았다** — 측정 방식의 문제로 설명되지 않음\n- 오목형 2건은 \"어느 시점까지는 경력이 도움되다가 이후 역전\"을 시사하나 건수가 적어 정점 시기를 특정할 수 없다",
      sources: []
    },
    "follow-up-evidence": {
      content: "> Researcher 검증 2026-08-10. 2005년 결론은 **진료량(volume) · 영역(인지 vs 술기) · 현재 지식수준** 3개 조절변수에 의해 성립 여부가 갈린다.\n\n### ✅ 성립하는 조건 — 인지적 진료 + 저volume\n| 근거 | 내용 |\n|---|---|\n| Tsugawa Y. BMJ 2017;357:j1797 (PMID:28512089) | 입원전담의 연령↑ → 환자 30일 사망률 **10.8% → 12.1%**. **단 고volume 의사에서는 연관 소실** |\n\n→ **진료량이 방어 인자**. 해당 영역을 계속 많이 보고 있으면 경력의 부정적 연관이 나타나지 않는다.\n\n### ❌ 성립하지 않는 조건 — 술기(surgical) 영역\n| 근거 | 내용 |\n|---|---|\n| Tsugawa Y. BMJ 2018;361:k1343 (PMID:29695473) | 외과의 연령↑ → 수술 사망률 **6.6% → 6.3%** (p for trend 0.001) — **방향 역전** |\n\n→ 손기술·시술 영역에서는 경력이 오히려 유리. 2005년 결론을 술기 영역에 그대로 적용 금지.\n\n### 🔍 기전 정정 — 경력이 아니라 \"현재 지식수준\"\n| 근거 | 내용 |\n|---|---|\n| Gray BM. JAMA Netw Open 2021;4(7):e2115328 (PMID:34196714) | 가이드라인 전환기 처방 적정성을 가른 것은 경력 연수가 아니라 **현재 지식수준(ABIM 시험 성적)** |\n\n→ 진짜 변수는 tenure가 아니라 **knowledge currency(지식 최신성)**.\n\n### ⚖ 교정 가능성 — 있지만 개입 효과는 미확립\n| 근거 | 내용 |\n|---|---|\n| Vandergrift JL. Health Serv Res 2018;53(3):1682-701 (PMID:28419451) | 주(州) CME 요건 강화 → 지식 점수 **50 → 54 백분위**. 지식 감퇴는 소폭이나 교정 가능 |\n| Gray BM. JAMA 2014;312(22):2348-57 (PMID:25490325) | 인증 유지(MOC) 의무화는 **외래 민감 입원(ACSH) 감소와 무관** |\n\n→ 원 논문의 \"QI intervention 대상\" 권고는 **개입 효과로 직접 뒷받침되지 않는다**.",
      sources: [
        "Tsugawa Y. BMJ 2017;357:j1797. PMID:28512089",
        "Tsugawa Y. BMJ 2018;361:k1343. PMID:29695473",
        "Gray BM. JAMA Netw Open 2021;4(7):e2115328. PMID:34196714",
        "Vandergrift JL. Health Serv Res 2018;53(3):1682-701. PMID:28419451",
        "Gray BM. JAMA 2014;312(22):2348-57. PMID:25490325"
      ]
    },
    "self-audit-routine": {
      content: "원 논문의 결론은 **\"오래 진료한 의사가 낮은 질의 의료를 제공할 위험이 있으며, 이 subgroup이 질 향상 개입(quality improvement intervention)의 대상\"** 이다. 외래 자가 점검으로 옮기면:\n\n1. **\"내가 이 방식으로 계속 해왔다\"는 익숙함은 근거가 아니다** — 수련 시점의 표준이 현재 표준과 같은지 별도 확인\n2. **가이드라인 개정 추적을 routine으로** — 경력 자체가 최신성을 보장하지 않음\n3. **객관적 지표로 자기 진료 확인** — 자기평가·자신감은 이 연구가 측정한 \"수행\"과 별개 축\n4. **오래 유지해온 처방 습관을 우선 재검토 대상으로** — 변화 없이 유지된 패턴일수록 노후화 위험이 큼\n5. **드물게 보는 영역이 위험 구간** — Tsugawa 2017에서 고volume 의사는 연관이 소실됐다. 자주 보는 질환보다 **가끔 오는 질환**에서 지식 노후화가 드러난다\n6. **점검 표적은 \"연차\"가 아니라 \"지금 아는가\"** — Gray 2021 기준. 자가 점검은 경력 연수가 아니라 knowledge currency를 겨냥해야 한다\n\n> ⚠ 이 논문은 **연관(association) 관찰**이다. 개별 의사의 경력이 곧 낮은 질을 의미하지 않으며, 집단 수준 경향에서 도출된 자가 점검 신호로만 사용한다. 위 항목은 논문 결론에서 도출한 적용안이며 논문이 검증한 개입이 아니다 — **CME·MOC 의무화가 환자 outcome을 개선한다는 근거는 아직 없다** (Gray 2014).",
      sources: []
    },
    precaution: {
      content: "- **저자 명시 한계**: \"physician experience\"에 대한 신뢰할 만한 검색어(reliable search terms)가 없어 **관련 데이터를 제공한 보고서를 놓쳤을 가능성**이 있다\n- 관찰 연구들의 종합 — 인과관계 입증이 아니라 연관 관찰\n- 검색 종료 시점이 **2004년 6월** — 이후의 전자적 의사결정지원·의무 CME·인증 유지(MOC) 확산 효과는 반영되지 않음\n- **연령과 경력이 분리되지 않은 교란 구조** — 원 논문과 Tsugawa 2017/2018 모두 physician age를 경력의 대리변수로 사용\n- **한국 일차의료 실증근거 없음** — 근거 전량이 미국·영국·캐나다 병원/보험청구 코호트(Tsugawa 2건은 전량 US Medicare). 게이트키핑 부재·행위별수가·초단시간 진료가 질 변이를 지배하는 **한국 개원가로는 직접 외삽 불가** [출처 미확인 — 한국 데이터 검색 실패, Researcher 2026-08-10]",
      sources: []
    },
    notes: {
...
KNOWLEDGE_BUNDLE["clinical-experience-quality"] = _clinical_experience_quality_v2;
KNOWLEDGE_BUNDLE["임상 경력과 진료 질"] = _clinical_experience_quality_v2;
KNOWLEDGE_BUNDLE["clinical experience"] = _clinical_experience_quality_v2;
KNOWLEDGE_BUNDLE["years in practice"] = _clinical_experience_quality_v2;
KNOWLEDGE_BUNDLE["physician age"] = _clinical_experience_quality_v2;
KNOWLEDGE_BUNDLE["지식 노후화"] = _clinical_experience_quality_v2;
